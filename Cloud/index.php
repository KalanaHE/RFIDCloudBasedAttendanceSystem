...
<link rel="shortcut icon" href="../myweb/images/favicon.ico">
  ...
  <title>LOGIN - Cloud Based Attendance Monitoring System</title>
...
<form action="logincontroller.php" method="POST">
	...
	<div class="alert alert-warning alert-dismissible fade show">
		    ...
		    <strong>Password: </strong> helloworld
	</div>
	...
	<div class="inputGroup inputGroup1">
		...
		<input type="text" id="email" name="uname" class="email" maxlength="256"/>
		<p class="helper helper1">Your username</p>
		<span class="indicator"></span>
	</div>
	<div class="inputGroup inputGroup2">
		<label for="password">Password</label>
		<input type="password" name="pword" id="password" class="password" />
	</div>
